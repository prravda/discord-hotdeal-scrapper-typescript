...
```shell
/Users/pravda/development/personal/discord-bot-typescript/infra/config.ts:30
        throw new Error(`Validation error: ${error.message}`);
              ^
Error: Validation error: "DISCORD_API_VERSION" is required
    at validateEnvList (/Users/pravda/development/personal/discord-bot-typescript/infra/config.ts:30:15)
    at Object.<anonymous> (/Users/pravda/development/personal/discord-bot-typescript/infra/config.ts:36:23)
